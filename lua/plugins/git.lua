			...
			return {
				...
				file_panel = {
					...
					win_config = function()
						...
						return { position = "left", width = editor_width >= 247 and 45 or 35 }
					end,
				},
				file_history_panel = {
					log_options = {
				...
				keymaps = {
					...
					file_panel = {
						...
						{ "n", "]c", actions.view_windo(function(_, sym) if sym == "b" then vim.cmd("norm! ]c") end end) },
						{ "n", "do", actions.view_windo(function(_, sym) if sym == "b" then vim.cmd("norm! do") end end) },
						{ "n", "dp", actions.view_windo(function(_, sym) if sym == "b" then vim.cmd("norm! dp") end end) },
					},
