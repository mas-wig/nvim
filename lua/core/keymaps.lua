...
-- save file
map({ "i", "x", "n", "s" }, "<C-s>", "<cmd>wall<cr><esc>", { desc = "Save file", silent = true })
...
map("n", "<Tab>1", "1gt", { desc = "Go to tab 1" })
map("n", "<Tab>2", "2gt", { desc = "Go to tab 2" })
map("n", "<Tab>3", "3gt", { desc = "Go to tab 3" })
map("n", "<Tab>4", "4gt", { desc = "Go to tab 4" })
map("n", "<Tab>5", "5gt", { desc = "Go to tab 5" })
map("n", "<Tab>6", "6gt", { desc = "Go to tab 6" })
map("n", "<Tab>7", "7gt", { desc = "Go to tab 7" })
map("n", "<Tab>8", "8gt", { desc = "Go to tab 8" })
map("n", "<Tab>9", "9gt", { desc = "Go to tab 9" })
